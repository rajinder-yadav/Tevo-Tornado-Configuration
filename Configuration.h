...
#define STRING_CONFIG_H_AUTHOR "(DevMentor, Tevo Tornado V2.1)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Tevo Tornado (Obtained using G-Code M303)
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Tevo Tornado (Obtained using G-Code M303 E-1)
  #define  DEFAULT_bedKp 20.59
  #define  DEFAULT_bedKi 3.75
  #define  DEFAULT_bedKd 75.36
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3190, 80.3190, 400, 400 }
